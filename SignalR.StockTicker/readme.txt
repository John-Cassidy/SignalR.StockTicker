...
To enable and run the SignalR sample in your application follow these steps:
    ...
    4. To generate the signal/hubs script, open browser and go to: http://localhost:57564/signalr/hubs
        save script as SignalR.StockTicker.Server.js

        update any html or javascript file that that references singalr/hubs to SignalR.StockTicker.Server.js